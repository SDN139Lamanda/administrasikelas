...
export function formatMapelName(mapel) { const names = { 'matematika': 'Matematika', 'ipas': 'IPAS', 'bahasa-indonesia': 'Bahasa Indonesia', 'pjok': 'PJOK', 'seni-budaya': 'Seni Budaya', 'PAIBD' : 'PAIBD', 'lainnya': 'Lainnya' }; return names[mapel] || mapel; }
