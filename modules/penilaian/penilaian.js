 ...
 * ✅ UPDATE: Mobile layout - normal scroll behavior (no sticky column)
 */
...
// ✅ SWITCH VIEW - Expose to window for HTML onclick
window.switchView = function(mode) {
    viewAktif = mode;
    if(indexAktif !== null) renderTabel();
}

// ✅ TAMBAH KOLOM PH - Expose to window for HTML onclick
...
// ✅ INIT TABLE - Expose to window for HTML onchange
...
function renderTabel() {
    ...
    if(viewAktif === 'pengetahuan') {
        ...
        // ✅ UPDATE: Hapus sticky-col, tambah border separator untuk mobile
        head.innerHTML = `<tr>
...
// ✅ CALCULATE NA - Expose to window for HTML oninput
...
// ✅ SAVE - Expose to window for HTML onclick + FIX: Valid object syntax
...
// ✅ UPDATE SEMUA WARNA - Expose to window for HTML oninput
...
console.log('🟢 [Penilaian] Module LOADED - Integrated with Adm. Kelas + Student Data Fix + Action Buttons + Mobile Layout');
