        ...
        <div class="penilaian-container min-h-screen flex flex-col md:flex-row bg-slate-50">
            ...
            <aside class="w-full md:w-72 sidebar-gradient text-slate-300 p-8 shadow-2xl z-20">
                ...
                <nav class="space-y-4">
                    ...
                    <button onclick="window.switchView('pengetahuan')" id="btnPengetahuan" class="w-full flex items-center space-x-4 px-4 py-3 rounded-2xl bg-blue-600 text-white shadow-lg shadow-blue-500/30 transition-all">
            ...
            <main class="flex-1 p-6 md:p-12 overflow-x-hidden">
                ...
                <header class="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-10 gap-6">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <select id="selectKelasNilai" onchange="window.inisialisasiTabel(this.value)" class="bg-white border-2 border-slate-100 px-6 py-3 rounded-xl font-bold text-slate-700 outline-none shadow-sm focus:border-blue-500 transition-all">
                            <option value="">-- Pilih Kelas --</option>
                        </select>
                        <button onclick="window.simpanPermanen()" class="bg-slate-900 text-white px-8 py-3 rounded-xl font-bold shadow-lg hover:bg-slate-800 transition-all">
                ...
                <div id="kontrolPengetahuan" class="flex flex-wrap gap-4 mb-8">
                    ...
                    <div class="flex items-center space-x-2 px-4 py-3 bg-slate-100 rounded-xl">
                        ...
                        <input type="number" id="inputKKM" value="75" class="w-12 bg-transparent border-none text-center font-bold text-rose-600 outline-none">
                    </div>
                </div>
