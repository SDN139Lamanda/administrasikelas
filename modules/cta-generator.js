  ...
  container.innerHTML = `
    ...
    <div class="cta-generator-form">
      ...
      <form id="cta-form">
        ...
        <div class="grid-cols-2">
          <div><label for="cta-mapel"><i class="fas fa-book mr-2"></i>Mata Pelajaran</label><select id="cta-mapel" required><option value="">Pilih</option><option value="matematika">Matematika</option><option value="ipas">IPAS</option><option value="bahasa-indonesia">Bahasa Indonesia</option><option value="pjok">PJOK</option><option value="paibd">paibd</option><option value="Pendidikan Kewarganegaraan">PKn</option><option value="Bahasa Inggris">BAHASA INGGRIS</option><option value="Seni Budaya">SENI BUDAYA</option><option value="lainnya">Lainnya</option></select></div>
