 ...
 * Same look as before, clean implementation
 */
  ...
  return `
    <div class="adm-kelas-module">
      ...
      <div id="viewKelas" class="view-section">
        <!-- Kelas view content loaded dynamically -->
      </div>
      ...
      <div id="viewSiswa" class="view-section hidden">
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="flex gap-2">
            <button onclick="window.admKelas.openStudentModal()" class="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-sm font-medium transition">
              + Siswa
            </button>
            <button onclick="window.admKelas.showView('viewKelas')" class="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 rounded-lg text-sm font-medium transition">
              ← Kembali
            </button>
          </div>
        </div>
      ...
      <div id="viewPresensi" class="view-section hidden">
        ...
        <div class="bg-white rounded-2xl shadow-sm border p-4 mb-4">
          ...
          <button onclick="window.admKelas.markAllPresent()" class="ml-4 px-3 py-1.5 bg-emerald-100 hover:bg-emerald-200 text-emerald-700 rounded-lg text-sm font-medium transition">
            ✓ Semua Hadir
          </button>
        </div>
        <div class="bg-white rounded-2xl shadow-sm border overflow-hidden">
        ...
        <button onclick="window.admKelas.saveAttendance()" class="mt-4 w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-medium transition">
          💾 Simpan Absensi
        </button>
      </div>
      ...
      <div id="viewRekap" class="view-section hidden">
        ...
        <div class="bg-white rounded-2xl shadow-sm border p-4 mb-4">
          <select id="tipeRekap" onchange="window.admKelas.toggleFilterView()" class="px-3 py-1.5 bg-white border rounded-lg text-sm mr-2">
            <option value="hari">Harian</option>
            <option value="bulan">Bulanan</option>
            <option value="semester">Semester</option>
          </select>
          <span id="filterInputs" class="inline-flex items-center gap-2"></span>
          <button onclick="window.admKelas.renderRecap()" class="ml-2 px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm font-medium transition">
            Tampilkan
          </button>
        </div>
        ...
        <button onclick="window.admKelas.downloadPDF()" class="mt-4 w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-medium transition">
          📄 Export PDF
        </button>
      </div>
